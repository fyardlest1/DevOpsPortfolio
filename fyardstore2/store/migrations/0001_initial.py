# Generated by Django 4.0.4 on 2022-06-30 04:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_in_collection', models.IntegerField(validators=[django.core.validators.MinValueValidator(0)])),
            ],
            options={
                'ordering': ['title'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('P', 'Pending'), ('C', 'Complete'), ('F', 'Fail')], default='P', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='products', to='store.collection')),
            ],
            options={
                'ordering': ['title'],
            },
